...
def worker_to_visual_words(wind, num_cores, point_method):
...
def batch_to_visual_words(num_cores, point_method):
    ...
    for i in range(num_cores):
        workers.append(multiprocessing.Process(target=worker_to_visual_words, args=(i, num_cores, point_method)))
